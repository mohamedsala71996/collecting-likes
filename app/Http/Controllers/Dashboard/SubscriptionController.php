...
class SubscriptionController extends Controller
{
    ...
    {
         $this->middleware('permission:قائمة الاشتراكات والبحث', ['only' => ['index','search']]);
         $this->middleware('permission:التحكم في الاشتراكات', ['only' => ['accepted_sub','cancelled_sub','makeCancel','reActive','active']]);
    }
