...
<img class="avatar img-thumbnail rounded-circle shadow" src="{{ asset('images/dashboard/like4like.png') }}" alt="">
...
<li><a class="ms-link" href="{{route('socials.index')}}">اعدادات روابط السوشيال ميديا</a></li>
