            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('adds.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text"  class="form-control @error('company_name') is-invalid @enderror" id="name" name="company_name" placeholder="ادخل الاسم" value="{{ old('company_name') }}" required>
                                @error('company_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="url" class="form-control @error('url') is-invalid @enderror" id="url" name="url" placeholder="ادخل  الرابط" value="{{ old('url') }}" required>
                                @error('url')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3 col-4">
                                ...
                                <input type="number" name="second" class="form-control @error('second') is-invalid @enderror" id="second" placeholder="ادخل  الثواني" value="{{ old('second') }}" required>
                                @error('second')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3 col-4">
                                ...
                                <input type="color" name="color" class="form-control @error('color') is-invalid @enderror" id="color" placeholder="ادخل  اللون" value="{{ old('color') }}" required>
                                @error('color')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mb-3 col-4">
                                ...
                                <select name="place" class="form-select @error('place') is-invalid @enderror" id="type" required>
                 ...
                 <option value="3" {{ old('place') == '4' ? 'selected' : '' }}>ثالث سليدر </option>
                            ...
                            <div class="mb-3 col-4">
                                <label for="type" class="form-label text-primary">النوع</label>
                                <select name="status" class="form-select @error('status') is-invalid @enderror" id="type" required>
                                    <option value="">اختر النوع</option>
